<div class="wrap">
<h2><?php _e( 'Add Category', MM_TEXTDOMAIN ); ?></h2>
...
<form method="post" action="admin.php?page=<?php echo $page_name; ?>&amp;action=create">
    <?php wp_nonce_field( 'add_category', 'mm_nonce' ); ?>
    <table class="form-table" id="mm_category_form_table">
        <tr valign="top">
        <th scope="row"><?php _e( 'Category name', MM_TEXTDOMAIN ); ?></th>
        <td>
            <input type="text" name="mm_category[gt_name]" value="<?php echo $category->gt_name; ?>" size="70" />
        ...
        <tr valign="top">
        <th scope="row"><?php _e( 'title tag', MM_TEXTDOMAIN ); ?></th>
        <td>
